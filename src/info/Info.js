...
export const info = {
  ...
  portfolio: [
    ...
    {
      title: 'Yesterday',
      live: 'https://www.orderyesterday.com/nelson', //this should be a link to the live version of your project, think github pages, netlify, heroku, etc. Or your own domain, if you have it.
